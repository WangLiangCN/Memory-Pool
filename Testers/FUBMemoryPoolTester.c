/**
 * @file   FUBMemoryPoolTester.c
 *
 * @date   Oct 27, 2011
 * @author WangLiang
 * @email  WangLiangCN@live.com
 *
 * @brief  Tester program for FUB memory pool, for test purpose only.
 */

#include "../FUBMemoryPool/MemoryPool.h"
 ...
 */
int FUBMemoryPoolTester()
{
#ifdef ORDERING_TEST
	FUBMemoryPoolOrderingTester();
#else
	FUBMemoryPoolRandomTester();
#endif
	return 0;
}
